...
HD_PWD='H:/DL_202030_My_Nguyen/lab06/implement/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sseg_decoder_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sseg_decoder_test.tcl -notrace
