...
HD_PWD='H:/DL_202030_My_Nguyen/lab06/implement/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sseg_decoder_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sseg_decoder_test.tcl
