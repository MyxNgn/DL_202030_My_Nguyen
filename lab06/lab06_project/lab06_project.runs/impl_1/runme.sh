...
HD_PWD='H:/DL_202030_My_Nguyen/lab06/lab06_project/lab06_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sseg1_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sseg1_test.tcl -notrace
